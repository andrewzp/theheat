...
This signal detects when a whole region runs far above its seasonal normal — the thing single-city records miss ("the entire Sahel ran 8°C above normal for a week"). It is a **POINT INDEX over N sampled cities**, computed from ERA5 reanalysis daily-max against a 1991–2020 daily normal. It is **NOT** an area-weighted national mean, and it is **NOT** a station observation.
...
4. **Name the stakes — but only what the index can see.** A daily-max anomaly this large, sustained eight days, is not a statistic: the region's afternoons ran like a much hotter climate's, day after day, for over a week. Make the reader feel that scale. The index is **daily-max only**, so do NOT invent what it cannot show — no overnight-low or "no nighttime relief / no nighttime reset" claims, no health, mortality, or infrastructure outcomes the bundle does not carry. The stakes are the size and persistence of the *daytime* departure itself; that is the load-bearing system clause.
...
- ✓ finding: *"Six French cities just ran ~12°C above their 1991–2020 normal for eight straight days — a sustained 2.8σ anomaly, the margin where 'above average' stops describing it. For a week, France was effectively living a hotter country's summer. It eased June 27."*
...
- `historical_context.sustained_days` — a real multi-day streak, so directional/sustained language ("ran above normal for N straight days") is fair here, unlike snapshot signals. The *duration* is half the story: a one-day +12°C is weather; eight straight days is a climate the region was living in.
