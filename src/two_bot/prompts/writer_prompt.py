...
- `nearest_region` may read `"near <city>"` — the geocoder's honest nearest-city fallback when the hotspot fell outside every curated region box. Cite it verbatim (it already satisfies the geography-qualifier rule above); never upgrade "near <city>" into a claim the fire is IN that city — the point could be a hundred kilometers out.
