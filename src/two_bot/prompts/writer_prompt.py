...
4. **Name the stakes.** A +11°C daily-max anomaly sustained eight days is not a statistic — it means the region ran a hotter country's summer for a week, with no nighttime reset. Make the reader feel the scale: what it is like to live inside the number, or what a departure this large and this sustained does. That is the load-bearing system clause.
...
- `historical_context.sustained_days` — a real multi-day streak, so directional/sustained language ("ran above normal for N straight days") is fair here, unlike snapshot signals. The *duration* is half the story: a one-day +11°C is weather; eight straight days is a climate the region was living in.
