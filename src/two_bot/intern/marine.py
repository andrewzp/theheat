...
def build_extreme_wave_bundle(wave: ExtremeWaveEvent) -> StoryBundle:
    ...
    return StoryBundle(
        ...
        current_facts=[
            ...
            {"label": "provider_time", "value": wave.evidence},
            {"label": "claim_limit", "value": "A marine model forecast for the stated provider-local day, not an observed wave measurement"},
        ],
        historical_context={},
