...
**Last updated:** 2026-06-27 (release 0.9.81.0). **Canonical production resume: [/Users/andrewpuschel/Documents/Claude/theheat/docs/handoffs/2026-06-27.md](/Users/andrewpuschel/Documents/Claude/theheat/docs/handoffs/2026-06-27.md)** (supersedes all prior handoffs). Most recent change: the **regional-heatwave detector (`reanalysis_anomaly`/reganom) was ACTIVATED** ([#203](https://github.com/andrewzp/theheat/pull/203) + calibration fix [#343](https://github.com/andrewzp/theheat/pull/343), 2026-06-26, `manual_only`) after sitting dormant since 06-09 — it catches the broad regional heatwaves single-station records miss (proven live for the European heatwave) — see `PIPELINE.md` and the 2026-06-27 handoff.
