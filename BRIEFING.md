...
**Last updated:** 2026-06-26 (release 0.9.81.0). **Canonical production resume: [/Users/andrewpuschel/Documents/Claude/theheat/docs/handoffs/2026-06-26.md](/Users/andrewpuschel/Documents/Claude/theheat/docs/handoffs/2026-06-26.md)** (supersedes all prior handoffs). Most recent change: the non-US world temperature half is now backed by a threshold cache ([#338](https://github.com/andrewzp/theheat/pull/338), 2026-06-26), replacing the live-archive-per-city model that was silently rate-limited — see `PIPELINE.md` and the 2026-06-26 handoff.
