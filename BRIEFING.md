...
**Last updated:** 2026-05-22 (post-Codex-sweep release 0.9.0.0 — evidence contract + all-sources triage + fact-check/claim-extract collapse + sea_ice & ice_mass URL fixes + Earthdata operator actions completed).
**Status:** **DATA LAYER COMPLETE; 23 SOURCES LIVE; EDITORIAL PIPELINE END-TO-END HARDENED; ALL SOURCES NOW ON THE TRIAGE PATH; EVIDENCE CONTRACT GATES THE WRITER; POSTING STILL PAUSED PENDING ANDREW'S RE-ENABLE SIGNAL ON NEW ARCHITECTURE.** The 0.7.1.0 release added the editorial loop (F3 critic). The 0.7.2.0 release added post-wave hardening + the triage spec. The 0.8.0.0 release shipped the triage MVP + Anthropic prompt caching. **The 0.9.0.0 release (this one) finishes the triage migration (every source now routes through it), adds a deterministic source-to-writer evidence contract, collapses the claim_extractor+fact_check pair into a single Gemini call, resurrects sea_ice and ice_mass from silently-dead URLs, and closes both NASA Earthdata app-authorization operator actions.** See [/Users/andrewpuschel/Documents/Claude/theheat/CHANGELOG.md](/Users/andrewpuschel/Documents/Claude/theheat/CHANGELOG.md) 0.9.0.0 for the full release notes and [/Users/andrewpuschel/Documents/Claude/theheat/docs/handoffs/2026-05-22.md](/Users/andrewpuschel/Documents/Claude/theheat/docs/handoffs/2026-05-22.md) for the current next-session prompt.
