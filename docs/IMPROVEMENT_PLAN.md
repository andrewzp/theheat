...
| Last cycle A-rate | **— (0 fresh drafts, Jul 29 — 6th consecutive zero-fresh cycle, a new record for the corpus's longest dry spell, extending Jul 28's own record).** Most recent measured: **50% (2/4, Jul 23) — bar NOT cleared** (not a majority; same convention as Jul 8/Jul 9). Prior: 67% (2/3, Jul 22) — BAR CLEARED, 4th clearance since Jun 29; 0% (0/1, Jul 21, smallest fresh sample in the corpus's history); 33% (1/3, Jul 20); 25% (1/4, Jul 19); 25% (1/4, Jul 18); 80% (4/5, Jul 17); 100% (2/2, Jul 16, small-n); no fresh drafts Jul 15; 33% (1/3, Jul 14); no fresh drafts Jul 12–13; 0% (0/2, Jul 11); 33% (1/3, Jul 10); 50% (1/2, Jul 9, not a majority); 50% (4/8, Jul 8); 33% (2/6, Jul 7); no fresh drafts Jul 6; 20% (1/5, Jul 5); 20% (2/10, Jul 4); 33% (1/3, Jul 3); 0% (0/3, Jul 2); 0% (0/4, Jul 1); 22% (2/9 non-stale, Jun 30); 80% Jun 29 [BAR CLEARED]. |
| Resumption bar | majority A (>50%) sustained — **cleared Jun 29 (80%, n=5); Jun 30 returned 22%; Jul 1 0% (n=4); Jul 2 0% (n=3); Jul 3 33% (n=3); Jul 4 20% (n=10); Jul 5 20% (n=5); Jul 6 no fresh drafts; Jul 7 33% (n=6); Jul 8 50% (n=8, not a majority); Jul 9 50% (n=2, not a majority); Jul 10 33% (n=3); Jul 11 0% (n=2); Jul 12–13 no fresh drafts; Jul 14 33% (n=3); Jul 15 no fresh drafts; Jul 16 100% (n=2, small-n); Jul 17 80% (n=5) — cleared again, first n≥5 confirmation since Jun 29; Jul 18 25% (n=4); Jul 19 25% (n=4); Jul 20 33% (n=3); Jul 21 0% (n=1); Jul 22 67% (n=3) — cleared a 4th time; Jul 23 50% (n=4) — not a majority; Jul 24 no fresh drafts; Jul 25 no fresh drafts; Jul 26 no fresh drafts; Jul 27 no fresh drafts; Jul 28 no fresh drafts (5th consecutive); Jul 29 no fresh drafts (6th consecutive, new record)**. |
| Gap | **2pp below majority** (50% vs. >50% required, most recent measured cycle Jul 23, n=4) — the smallest miss in the corpus's history, but still ✗ by the letter. No fresh measurement Jul 24–29. P_close, P_compound, A7, and A8 remain the highest-leverage unimplemented levers, all unchanged since Jul 23 (no fresh evidence Jul 24–29). |
| Posting | paused; operator decision pending — Jun 29 cleared bar (80%, n=5), Jul 16 cleared it again (100%, n=2, small-n), Jul 17 cleared it a 3rd time with the first large-n confirmation (80%, n=5), Jul 18–21 fell back below bar (25%/25%/33%/0%), Jul 22 cleared it a 4th time (67%, n=3), Jul 23 fell back to 50% (n=4, just short of majority), **Jul 24–29 no fresh drafts (6 consecutive, a new record)**. Queue contracted from 14 (Jul 23) to 11 (Jul 24) to 5 (Jul 25) to 4 (Jul 26) to 2 (Jul 27) to 1 (Jul 28) and **held at 1 (Jul 29)** — zero new drafts entered any of the six cycles; 3 of Jul 23's 14 dropped Jul 24 (Deaver A-, Al Basrah B+, Pikine A-), then 6 more of Jul 24's 11 dropped Jul 25 (Delhi B+, Wausaukee A-, Anchorage B, Astana B+, Doha B+, Al Başrah Al Qadīmah A-) — the largest single-cycle contraction recorded — then 1 more of Jul 25's 5 dropped Jul 26 (W Allis B+), then 2 more of Jul 26's 4 dropped Jul 27 (Taiz `dust_event` B+, Riyadh `dust_event` B), then 1 more of Jul 27's 2 dropped Jul 28 (Barrow `precipitation_extreme` B+, the queue's oldest survivor at 8 cycles), then **Jul 29 held steady at 1 — the first cycle since the pattern began where the queue size didn't move at all.** Five cycles of contraction data (-3, -6, -1, -2, -1) followed by one flat cycle show no clean monotonic trend, but the last 3 contracting cycles all drained the queue's longest-lived draft(s) first — still the strongest lead toward an age-based TTL sweep, though today's flat reading doesn't extend that evidence (only one draft remains, so there was nothing left to test the hypothesis against). **0 strict staleness bulk-reject candidates this cycle** — the one remaining draft is past-tense/historical, not forecast-elapsed. |
| Coverage | **638 cities × 180 countries** (was 613 × 179; +25 via PR #81) |
| Queue status | **1 pending as of Jul 29 grading, unchanged from Jul 28's 1 — the first cycle without contraction since the pattern began** — an exact match to Jul 23's graded batch (same `draft_id`/score/text): Capitol Hill 1 `record` C+ (Jul 23), now the corpus's oldest actively-carried draft at ~148.8h. **0 strict staleness candidates this cycle.** Bot at 0.9.108.1 per `main`'s `VERSION`; `THEHEAT_WRITER_SAMPLES=2` + `THEHEAT_CRITIC_REVISE_ENABLED=1` live. **P_tier's tracking remains CLOSED** (unchanged, no fresh `absolute_extreme` draft to retest). |

## Active proposals

Ordered by leverage. Priority as of Jul 29 (unchanged from Jul 24–28 — zero fresh drafts for a 6th
consecutive cycle means no new evidence to reorder against): **P_dust, P9, and P_tier remain
...
not tested Jul 24 through Jul 29 — no record-type draft among any of the six days' 0 fresh
drafts) > **A8** (opener-skeleton axis at 5 cycles, last evidence Jul 23; not tested Jul 24–29) >
**A7** (not tested Jul 22 through Jul 29) > **P5** (last evidence Jul 23). **A4, A5, A6, and A9 not
tested this cycle** (zero fresh drafts, 6th consecutive). **One operational item, not a voice
proposal, remains the plan's top priority regardless of ranking:** the queue-contraction pattern
that roughly doubled in size Jul 24→25 (11→5, -6, after Jul 23→24's -3), slowed sharply Jul 25→26
(5→4, -1), continued at a similarly small scale Jul 26→27 (4→2, -2), continued again Jul 27→28
(2→1, -1 — Barrow `precipitation_extreme`, carried 8 cycles), then **stalled entirely Jul 28→29
(1→1, no change)** — the first cycle since the pattern began where nothing dropped. Five cycles of
contraction data (-3, -6, -1, -2, -1) followed by one flat cycle show no clean monotonic trend,
but the last 3 contracting cycles running had drained the queue's longest-lived draft(s) first
(W Allis Jul 26, Taiz/Riyadh Jul 27, Barrow Jul 28) — still the strongest lead toward an
age-based TTL sweep as the mechanism, though today's flat reading can't extend that evidence
(only one draft remains, so there was nothing left to test the hypothesis against) and is at
least as consistent with the sweep simply having nothing left to remove. Continuing to flag this
above every voice proposal below: no amount of prompt tuning helps if graded drafts vanish before
they can be posted or re-evaluated, and **the queue has now sat at 1 pending for two consecutive
cycles** (Jul 28–29) — the next pull either empties it entirely (first time since the multi-week
Jun 21/22-era dry spell) or the single survivor keeps holding, which would itself be worth
investigating on the supply side: six consecutive cycles with nothing new reaching pending raises
the same "is voice the bottleneck or is the architecture?" question this plan's Jun-16 structural
note (below) already flagged.
