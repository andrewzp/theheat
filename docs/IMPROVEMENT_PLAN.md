...
not tested Jul 24 through Sep 3 — no record-type draft among any of the forty-two days' 0 fresh
drafts) > **A8** (opener-skeleton axis at 5 cycles, last evidence Jul 23; not tested Jul 24–Sep 3) >
**A7** (not tested Jul 22 through Sep 3) > **P5** (last evidence Jul 23). **A4, A5, A6, and A9 not
tested this cycle** (zero fresh drafts, 42nd consecutive).
