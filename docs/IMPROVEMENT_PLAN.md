...
| Last cycle A-rate | **— (0 fresh drafts, Jul 26 — 3rd consecutive zero-fresh cycle).** Most recent measured: **50% (2/4, Jul 23) — bar NOT cleared** (not a majority; same convention as Jul 8/Jul 9). Prior: 67% (2/3, Jul 22) — BAR CLEARED, 4th clearance since Jun 29; 0% (0/1, Jul 21, smallest fresh sample in the corpus's history); 33% (1/3, Jul 20); 25% (1/4, Jul 19); 25% (1/4, Jul 18); 80% (4/5, Jul 17); 100% (2/2, Jul 16, small-n); no fresh drafts Jul 15; 33% (1/3, Jul 14); no fresh drafts Jul 12–13; 0% (0/2, Jul 11); 33% (1/3, Jul 10); 50% (1/2, Jul 9, not a majority); 50% (4/8, Jul 8); 33% (2/6, Jul 7); no fresh drafts Jul 6; 20% (1/5, Jul 5); 20% (2/10, Jul 4); 33% (1/3, Jul 3); 0% (0/3, Jul 2); 0% (0/4, Jul 1); 22% (2/9 non-stale, Jun 30); 80% Jun 29 [BAR CLEARED]. |
| Resumption bar | majority A (>50%) sustained — **cleared Jun 29 (80%, n=5); Jun 30 returned 22%; Jul 1 0% (n=4); Jul 2 0% (n=3); Jul 3 33% (n=3); Jul 4 20% (n=10); Jul 5 20% (n=5); Jul 6 no fresh drafts; Jul 7 33% (n=6); Jul 8 50% (n=8, not a majority); Jul 9 50% (n=2, not a majority); Jul 10 33% (n=3); Jul 11 0% (n=2); Jul 12–13 no fresh drafts; Jul 14 33% (n=3); Jul 15 no fresh drafts; Jul 16 100% (n=2, small-n); Jul 17 80% (n=5) — cleared again, first n≥5 confirmation since Jun 29; Jul 18 25% (n=4); Jul 19 25% (n=4); Jul 20 33% (n=3); Jul 21 0% (n=1); Jul 22 67% (n=3) — cleared a 4th time; Jul 23 50% (n=4) — not a majority; Jul 24 no fresh drafts; Jul 25 no fresh drafts; Jul 26 no fresh drafts (3rd consecutive)**. |
| Gap | **2pp below majority** (50% vs. >50% required, most recent measured cycle Jul 23, n=4) — the smallest miss in the corpus's history, but still ✗ by the letter. No fresh measurement Jul 24, Jul 25, or Jul 26. P_close, P_compound, A7, and A8 remain the highest-leverage unimplemented levers, all unchanged since Jul 23 (no fresh evidence Jul 24–26). |
| Posting | paused; operator decision pending — Jun 29 cleared bar (80%, n=5), Jul 16 cleared it again (100%, n=2, small-n), Jul 17 cleared it a 3rd time with the first large-n confirmation (80%, n=5), Jul 18–21 fell back below bar (25%/25%/33%/0%), Jul 22 cleared it a 4th time (67%, n=3), Jul 23 fell back to 50% (n=4, just short of majority), **Jul 24–26 no fresh drafts (3 consecutive)**. Queue contracted from 14 (Jul 23) to 11 (Jul 24) to 5 (Jul 25) to **4 (Jul 26)** — zero new drafts entered any of the three cycles; 3 of Jul 23's 14 dropped Jul 24 (Deaver A-, Al Basrah B+, Pikine A-), then 6 more of Jul 24's 11 dropped Jul 25 (Delhi B+, Wausaukee A-, Anchorage B, Astana B+, Doha B+, Al Başrah Al Qadīmah A-) — the largest single-cycle contraction recorded — then **1 more of Jul 25's 5 dropped Jul 26** (W Allis B+), a much smaller drop that may signal the contraction pattern decelerating rather than continuing to escalate. **0 strict staleness bulk-reject candidates this cycle** — all 4 remaining drafts are past-tense/historical, none forecast-elapsed. |
| Coverage | **638 cities × 180 countries** (was 613 × 179; +25 via PR #81) |
| Queue status | **4 pending as of Jul 26 grading, down from Jul 25's 5** — all 4 are an exact subset of Jul 20–23's graded batch (same `draft_id`s/scores/text), no re-grading performed: Taiz `dust_event` B+ (Jul 20), Riyadh `dust_event` B (Jul 20), Barrow `precipitation_extreme` B+ (Jul 21), Capitol Hill 1 `record` C+ (Jul 23). **W Allis, Wisconsin `all_time_high` B+ (Jul 19, carried 8 cycles, the queue's longest-lived draft) dropped from the queue, cause unconfirmed** — a single-draft contraction, notably smaller than the prior two cycles' -3 and -6. **0 strict staleness candidates this cycle.** Bot at 0.9.108.1 per `main`'s `VERSION`; `THEHEAT_WRITER_SAMPLES=2` + `THEHEAT_CRITIC_REVISE_ENABLED=1` live. **P_tier's tracking remains CLOSED** (unchanged, no fresh `absolute_extreme` draft to retest). |

## Active proposals

Ordered by leverage. Priority as of Jul 26 (unchanged from Jul 24–25 — zero fresh drafts for a 3rd
...
not tested Jul 24, Jul 25, or Jul 26 — no record-type draft among any of the three days' 0 fresh
drafts) > **A8** (opener-skeleton axis at 5 cycles, last evidence Jul 23; not tested Jul 24–26) >
**A7** (not tested Jul 22 through Jul 26) > **P5** (last evidence Jul 23). **A4, A5, A6, and A9 not
tested this cycle** (zero fresh drafts, 3rd consecutive). **One operational item, not a voice
proposal, remains the plan's top priority regardless of ranking:** the queue-contraction pattern
that roughly doubled in size Jul 24→25 (11→5, -6, after Jul 23→24's -3) slowed sharply this cycle
(5→4, -1 — W Allis, Wisconsin `all_time_high` B+, carried 8 cycles). One quieter cycle doesn't
confirm the pattern has resolved — the mechanism (bulk sweep, TTL pass, or dashboard action) is
still unconfirmed, and the queue has now gone three straight cycles with zero fresh drafts arriving
to replace anything that drains. Continuing to flag this above every voice proposal below: no
amount of prompt tuning helps if graded drafts vanish before they can be posted or re-evaluated,
and at 4 pending the queue is one or two more contractions away from empty.
