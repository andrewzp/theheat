...
| 2026-04-30 | N/A | — | — | — | — | **N/A** | — | Gist API rate-limited (unauthenticated curl; 60 req/hr limit hit on shared runner). Queue state unknown. No grading, no staleness check. Fix: add GH_GIST_TOKEN auth header to grader curl. Last known A-rate remains 0% (Apr 29). |
