...
| 2026-04-28 | 0 | — | — | — | — | — | ✗ | Gist inaccessible — unauthenticated GitHub API rate-limit; no auth token in env; proxy allowlist blocks api.github.com. No drafts graded. Queue from Apr 28 alert cycles unseen. |
