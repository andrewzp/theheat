...
This brief **supersedes** `2026-05-12.md`. That doc was written earlier in the day; this one captures the full-day cleanup wave that followed (4 more merged PRs, 4 stale PRs closed, production fixes for the entire day's kill cascade).
...
git log --oneline -1 -- docs/handoffs/2026-05-12-v2.md
```
