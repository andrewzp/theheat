...
- [2026-06-08-v2.md](/Users/andrewpuschel/Documents/Claude/theheat/docs/handoffs/2026-06-08-v2.md) — **CURRENT.** Landed 0.9.16.1 (#191); planned + reviewed the full @extremetemps lane (#192) — 5 build-ready plans in docs/plans/ (4 ENG CLEARED, 1 deferred). Build order + Conductor parallelization caveat inside.
