...
- [2026-06-16.md](/Users/andrewpuschel/Documents/Claude/theheat/docs/handoffs/2026-06-16.md) — **CURRENT.** 0.9.81.0. SOURCE-REDUNDANCY is mostly shipped, with backup/fallback legs live for FIRMS, GPM IMERG, river gauges, coral DHW, sea ice, GDACS subtypes, Copernicus EMS, JTWC, and regional SST anomaly. ReliefWeb/GDACS full mirror remains AWAITING ANDREW appname approval. Dashboard source-health troubleshooting log is deployed, and publish-backed memory now records same-event/framing coverage only after a real post succeeds.
