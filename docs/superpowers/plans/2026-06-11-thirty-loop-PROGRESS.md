...
| S-02 | #30b | pytest config, README, PIPELINE glossary, critic passthrough, action versions | — | DONE | TBD | Local pytest defaults, README, current glossary, critic env, and action versions synced. |
