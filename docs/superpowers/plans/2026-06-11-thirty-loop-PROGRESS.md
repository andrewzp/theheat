...
| S-24 | #17 | Record margin-percentile fact | S-21 | BLOCKED(schema-no-history) | | Threshold DB stores only current record value/year, not margin-history distributions. |
