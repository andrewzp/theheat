...
| 13 | [row-13-heat-dome-spike.md](/Users/andrewpuschel/Documents/Claude/theheat/docs/superpowers/plans/front-page-parity/row-13-heat-dome-spike.md) | **SPIKE DONE 2026-07-07 → GO (US-first, county-scoped).** Data path verified: alert `geocode.SAME` county-FIPS → cached 1.69 MB Census CO-EST CSV (public domain), near-zero cost. One build dependency: a state-kept threshold baseline. Buildable when prioritized (not data-gated). See §Findings | ready to build |
