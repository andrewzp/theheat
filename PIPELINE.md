...
**Last updated:** 2026-06-08 (release 0.9.16.1: review follow-up hardening for source-health issue label/body sync, dashboard durable-source recovery, and gpm s3 -> datapool fallback). Authoritative current state: [/Users/andrewpuschel/Documents/Claude/theheat/docs/handoffs/2026-06-08-v2.md](/Users/andrewpuschel/Documents/Claude/theheat/docs/handoffs/2026-06-08-v2.md) (landed 0.9.16.1, planned @extremetemps coverage lane). Prior 2026-06-08 v1: grading routine restored, gpm feed live on `datapool`, per-type pending TTL — 0.9.15.0/0.9.16.0. Prior 2026-06-04 sweep: triage rollback, gpm_imerg walk-back exhaustion, source-health skip-aware recency, Actions repo-variable knobs, and routine-beacon docs. These harden the data-fetch + observability layers; the editorial pipeline shape described below is unchanged.
